...
void print_intro_flowchart() {
    std::cout << R"HFINTRO(
╔════════════════════════════════════════════════════════════════╗
║               ⚛️  Hartree-Fock Flowchart (SCF) ⚛️              ║
║                                                                ║
║        Prateek Saxena | BITS Pilani | 2021B2A12756P            ║
╠════════════════════════════════════════════════════════════════╣
║   Quantum chemistry meets linear algebra — it's not magic,     ║
║   it's *self-consistent field theory*. We're solving a many-   ║
║   electron problem using basis sets, Fock matrices!  ║
╚════════════════════════════════════════════════════════════════╝
...
int main(int argc, char* argv[]){
	...
	cout << "*                  *\n";
	cout << "********************\n\n";
	cout << " PRATEEK SAXENA_2021B2A12756P  \n";
	cout << " BITS PILANI    \n\n";
